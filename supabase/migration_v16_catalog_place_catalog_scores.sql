-- Каталог: брони + агрегаты отзывов, байесовский рейтинг и итоговый score для сортировки.
-- Требует migration_v15 (place_reviews). Выполнить в Supabase SQL Editor после v15.
